...
//         if(ans1 == -1){
//             return orderAgnousticBinarySearch(mountainArr,target, peak+1, mountainArr.length() -1);
//         } else{
//             return ans1;
//         }
//     }
//     static int orderAgnousticBinarySearch(MountainArray arr, int target, int start, int end) {
