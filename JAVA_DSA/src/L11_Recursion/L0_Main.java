...
// when a function is first called, it is added to stack memory and it remains
// there untill the function has stopped executing.

// when a funciton is finished executing it is removed from the stack, and the
// flow of program is restored to where that fucntion was called.
